                                ...
                                <div class="received_msg">
                                    <div class="received_withd_msg">
                                        ...
                                        <div class="borda">
                                            ...
                                            <p class="texto" style="color: #000;">Peça um orçamento ou faça perguntas sobre este profissional.
                                            </p>
                                ...
                                <div class="type_msg">
                                    <div class="input_msg_write form-group has-search">
                                        ...
                                        <button class="enviar-botao" type="button">
                                            <img class="fa fa-search form-control-feedback img"
                                                src="../medias/img/aperto-de-mao 1.svg" alt="mão" id="enviar"
                                                onclick="enviar()">
                                        </button>
